...
public class AuralAttributes extends NodeComponent {
   ...
   // Array for setting default read capabilities
    ...
    public void setAttributeGain(float gain) {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_ATTRIBUTE_GAIN_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes0"));
        ((AuralAttributesRetained)this.retained).setAttributeGain(gain);
    }
    ...
    public void setRolloff(float rolloff) {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_ROLLOFF_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes2"));
        ((AuralAttributesRetained)this.retained).setRolloff(rolloff);
    }
    ...
    public float getRolloff() {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_ROLLOFF_READ))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes3"));
    ...
    public void setReflectionCoefficient(float coefficient) {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_REFLECTION_COEFFICIENT_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes4"));
    ...
    public void setReflectionDelay(float reflectionDelay) {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_REFLECTION_DELAY_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes22"));
    ...
    public float getReflectionDelay() {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_REFLECTION_DELAY_READ))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes23"));
    ...
    public void setReverbCoefficient(float coefficient) {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_REVERB_COEFFICIENT_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes24"));
    ...
    public float getReverbCoefficient() {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_REVERB_COEFFICIENT_READ))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes25"));
    ...
    public float getReverbDelay() {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_REVERB_DELAY_READ))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes7"));
    ...
    public void setDecayTime(float decayTime) {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_DECAY_TIME_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes28"));
        ((AuralAttributesRetained)this.retained).setDecayTime(decayTime);
    }
    ...
    public void setDecayFilter(float frequencyCutoff) {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_DECAY_FILTER_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes30"));
    ...
    public void setDiffusion(float ratio) {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_DIFFUSION_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes32"));
    ...
    public float getDiffusion() {
        if (isLiveOrCompiled())
            if(!this.getCapability(ALLOW_DIFFUSION_READ))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes33"));
    ...
    public void setDensity(float ratio) {
        if (isLiveOrCompiled())
            if(!this.getCapability(ALLOW_DENSITY_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes34"));
    ...
    public float getDensity() {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_DENSITY_READ))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes35"));
    ...
    public Bounds getReverbBounds() {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_REVERB_DELAY_READ))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes27"));
    ...
    public void setReverbOrder(int reverbOrder) {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_REVERB_ORDER_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes8"));
        ((AuralAttributesRetained)this.retained).setReverbOrder(reverbOrder);
    }
    ...
    public void setDistanceFilter(Point2f[] attenuation) {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_DISTANCE_FILTER_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes10"));
    ...
    public float getFrequencyScaleFactor() {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_FREQUENCY_SCALE_FACTOR_READ))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes17"));
    ...
    public void setVelocityScaleFactor(float velocityScaleFactor) {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_VELOCITY_SCALE_FACTOR_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes19"));
        ((AuralAttributesRetained)this.retained).setVelocityScaleFactor(
                                     velocityScaleFactor);
    }
    ...
    public float getVelocityScaleFactor() {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_VELOCITY_SCALE_FACTOR_READ))
                throw new CapabilityNotSetException(Ding3dI18N.getString("AuralAttributes20"));

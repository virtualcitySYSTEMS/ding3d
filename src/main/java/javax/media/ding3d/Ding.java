/*
 * $RCSfile: Ding3dGraphics2DImpl.java,v $
 *
...
/**
 * Implementation class for Ding3dGraphics2D
 */

final class Ding3dGraphics2DImpl extends Ding3dGraphics2D {
    ...
    Ding3dGraphics2DImpl(Canvas3D c) {
	canvas3d = c;
    ...
    public void flush(boolean waiting) {
        ...
        if (hasBeenDisposed) {
            throw new IllegalStateException(Ding3dI18N.getString("Ding3dGraphics2D0"));
        }
		...
		return;
            ...
            if (!initTexMap) {
                ...
                if (!canvas3d.initTexturemapping(canvas3d.ctx,
                    ...
                    System.err.println("Ding3dGraphics2DImpl.copyDataToCanvas() : Fail to get texture resources ...");
	...
	} else if (action == Ding3dThread.NOTIFY) {
	    notify();
	    threadWaiting = false;
	}
    }

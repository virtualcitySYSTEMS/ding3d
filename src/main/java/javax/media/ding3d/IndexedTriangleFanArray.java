...
public class IndexedTriangleFanArray extends IndexedGeometryStripArray {
	...
	super(vertexCount, vertexFormat, indexCount, stripIndexCounts);
        ...
        if (vertexCount < 1)
	    throw new IllegalArgumentException(Ding3dI18N.getString("IndexedTriangleFanArray0"));

        if (indexCount < 3 )
	    throw new IllegalArgumentException(Ding3dI18N.getString("IndexedTriangleFanArray1"));
    }

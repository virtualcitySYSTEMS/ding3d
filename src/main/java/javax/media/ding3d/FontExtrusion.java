  ...
  Point2f [] pnts;
	...
	while (!pIt.isDone()) {
	   ...
	   if (flag == PathIterator.SEG_LINETO){
		 ...
		 throw new IllegalArgumentException(Ding3dI18N.getString("FontExtrusion0"));
	     ...
	     if (n != 0)
		throw new IllegalArgumentException(Ding3dI18N.getString("FontExtrusion3"));
	...
	pnts[num-1].y = 0.0f;
	if (pnts[0].x != 0.0f)
	  throw new IllegalArgumentException(Ding3dI18N.getString("FontExtrusion1"));

...
public class IndexedTriangleStripArray extends IndexedGeometryStripArray {
	...
	super(vertexCount, vertexFormat, indexCount, stripIndexCounts);
        ...
        if (vertexCount < 1)
	    throw new IllegalArgumentException(Ding3dI18N.getString("IndexedTriangleStripArray0"));

        if (indexCount < 3 )
	    throw new IllegalArgumentException(Ding3dI18N.getString("IndexedTriangleStripArray1"));
    }

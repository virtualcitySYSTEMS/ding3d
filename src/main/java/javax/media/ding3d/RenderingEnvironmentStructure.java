...
class RenderingEnvironmentStructure extends Ding3dStructure implements ObjectUpdate {
    /**
   ...
   // ArrayList of leafRetained object whose mirrorObjects
    ...
    Integer ogInsert = new Integer(Ding3dMessage.ORDERED_GROUP_INSERTED);
    Integer ogRemove = new Integer(Ding3dMessage.ORDERED_GROUP_REMOVED);
	...
	super(u, Ding3dThread.UPDATE_RENDERING_ENVIRONMENT);
    }
	...
	for (int i=0; i < nMsg; i++) {
		...
		break;
	    case Ding3dMessage.VIEWSPECIFICGROUP_INIT:
		initViewSpecificInfo(m);
		break;
	    case Ding3dMessage.VIEWSPECIFICGROUP_CLEAR:
    ...
    void updateOrderedGroupInserted(Ding3dMessage m) {
    ...
    void updateOrderedGroupsRemoved(Ding3dMessage m) {
	Object[] ogList = (Object[])m.args[0];
	Object[] ogChildIdList = (Object[])m.args[1];
	OrderedGroupRetained og;
	int index;
     ...
     */
    void processSwitchChanged(Ding3dMessage m) {
        int i;
        UnorderList arrList;
        int size;
    ...
    void initViewSpecificInfo(Ding3dMessage m) {
    ...
    void clearViewSpecificInfo(Ding3dMessage m) {
    ...
    void updateViewSpecificGroupChanged(Ding3dMessage m) {

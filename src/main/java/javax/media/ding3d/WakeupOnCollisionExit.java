...
public final class WakeupOnCollisionExit extends WakeupCriterion {
  ...
  // different types of WakeupIndexedList that use in GeometryStructure
	...
	if (behav == null) {
	    throw new IllegalStateException(Ding3dI18N.getString("WakeupOnCollisionExit5"));
	}

	synchronized (behav) {
	    if (!behav.inCallback) {
		throw new IllegalStateException
		    (Ding3dI18N.getString("WakeupOnCollisionExit5"));
	    }
	}
	...
	if (behav == null) {
	    throw new IllegalStateException(Ding3dI18N.getString("WakeupOnCollisionExit6"));
	}

	synchronized (behav) {
	    if (!behav.inCallback) {
		throw new IllegalStateException
		    (Ding3dI18N.getString("WakeupOnCollisionExit6"));
	    }
	}

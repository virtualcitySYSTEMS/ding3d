   ...
   // Array for setting default read capabilities
    ...
    public void setColor(Color3f color) {
	    ...
	    if(!this.getCapability(ALLOW_COLOR_WRITE))
	    	throw new CapabilityNotSetException(Ding3dI18N.getString("Fog0"));
    ...
    public void getColor(Color3f color) {
	    ...
	    if(!this.getCapability(ALLOW_COLOR_READ))
	    	throw new CapabilityNotSetException(Ding3dI18N.getString("Fog2"));
    ...
    public void setInfluencingBounds(Bounds region) {
	    ...
	    if(!this.getCapability(ALLOW_INFLUENCING_BOUNDS_WRITE))
	    	throw new CapabilityNotSetException(Ding3dI18N.getString("Fog3"));
    ...
    public Bounds getInfluencingBounds() {
	    ...
	    if(!this.getCapability(ALLOW_INFLUENCING_BOUNDS_READ))
	    	throw new CapabilityNotSetException(Ding3dI18N.getString("Fog4"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Fog7"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Fog8"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_SCOPE_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Fog9"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_SCOPE_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Fog10"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_SCOPE_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Fog11"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_SCOPE_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Fog12"));

...
class SoundscapeRetained extends LeafRetained
{
    ...
    int targetThreads = Ding3dThread.UPDATE_SOUND |
    ...
    void dispatchMessage(int dirtyBit, Object argument) {
        ...
        createMessage.type = Ding3dMessage.SOUNDSCAPE_CHANGED;
...
*/
	...
	if (inBackgroundGroup) {
	    throw new
                IllegalSceneGraphException(Ding3dI18N.getString("SoundscapeRetained1"));
        }

	if (inSharedGroup) {
	    throw new
		IllegalSharingException(Ding3dI18N.getString("SoundscapeRetained0"));
	}
	...
	s.notifyThreads |= (Ding3dThread.UPDATE_SOUND |
			    Ding3dThread.SOUND_SCHEDULER);

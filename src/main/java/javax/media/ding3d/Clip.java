    ...
    public void setBackDistance(double backDistance) {
        if (isLiveOrCompiled())
            if(!this.getCapability(ALLOW_BACK_DISTANCE_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("Clip0"));
    ...
    public double getBackDistance() {
        if (isLiveOrCompiled())
            if(!this.getCapability(ALLOW_BACK_DISTANCE_READ))
                throw new CapabilityNotSetException(Ding3dI18N.getString("Clip1"));
    ...
    public void setApplicationBounds(Bounds region) {
        if (isLiveOrCompiled())
            if(!this.getCapability(ALLOW_APPLICATION_BOUNDS_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("Clip2"));
    ...
    public Bounds getApplicationBounds() {
        if (isLiveOrCompiled())
            if(!this.getCapability(ALLOW_APPLICATION_BOUNDS_READ))
                throw new CapabilityNotSetException(Ding3dI18N.getString("Clip3"));

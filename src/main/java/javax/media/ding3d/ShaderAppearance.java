   ...
   // Array for setting default read capabilities
    ...
    public void setShaderProgram(ShaderProgram shaderProgram) {
	  ...
	  if(!this.getCapability(ALLOW_SHADER_PROGRAM_WRITE))
	    throw new CapabilityNotSetException(Ding3dI18N.getString("ShaderAppearance0"));
	}
    ...
    public ShaderProgram getShaderProgram() {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("ShaderAppearance1"));
	}
    ...
    public void setShaderAttributeSet(ShaderAttributeSet shaderAttributeSet) {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("ShaderAppearance2"));
	}
    ...
    public ShaderAttributeSet getShaderAttributeSet() {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("ShaderAppearance3"));
	}

...
public class BranchGroup extends Group {
   ...
   */
    public void compile() {
	    ...
	    throw new RestrictedAccessException(
				    Ding3dI18N.getString("BranchGroup0"));
	}
   ...
   */
    ...
    void validateModeFlagAndPickShape(int mode, int flags, PickShape pickShape) {
        ...
        if(isLive()==false) {
	    throw new IllegalStateException(Ding3dI18N.getString("BranchGroup3"));
        }

        if((mode != PickInfo.PICK_BOUNDS) && (mode != PickInfo.PICK_GEOMETRY)) {

          throw new IllegalArgumentException(Ding3dI18N.getString("BranchGroup4"));
        }

        if((pickShape instanceof PickPoint) && (mode == PickInfo.PICK_GEOMETRY)) {
          throw new IllegalArgumentException(Ding3dI18N.getString("BranchGroup5"));
        }

        if(((flags & PickInfo.CLOSEST_GEOM_INFO) != 0) &&
                ((flags & PickInfo.ALL_GEOM_INFO) != 0)) {
            throw new IllegalArgumentException(Ding3dI18N.getString("BranchGroup6"));
        }
        ...
        if((mode == PickInfo.PICK_BOUNDS) &&
          ...
          throw new IllegalArgumentException(Ding3dI18N.getString("BranchGroup7"));
        }
        ...
        if((pickShape instanceof PickBounds) &&
          ...
          throw new IllegalArgumentException(Ding3dI18N.getString("BranchGroup8"));
        }
   ...
   */
     ...
     * </ul>
     *
     * @see Locale#pickAll(int,int,javax.media.ding3d.PickShape)
     * @see PickInfo
     *
     * @since Java 3D 1.4
     *
   ...
   */
     ...
     * </ul>
     *
     * @see Locale#pickAllSorted(int,int,javax.media.ding3d.PickShape)
     * @see PickInfo
     *
     * @since Java 3D 1.4
     *
   ...
   */
     ...
     * </ul>
     *
     * @see Locale#pickClosest(int,int,javax.media.ding3d.PickShape)
     * @see PickInfo
     *
     * @since Java 3D 1.4
     *
   ...
   */
     ...
     * </ul>
     *
     * @see Locale#pickAny(int,int,javax.media.ding3d.PickShape)
     * @see PickInfo
     *
     * @since Java 3D 1.4
     *

...
public class BoundingBox extends Bounds {
    ...
    private Point3d tmpP3d = null;
     ...
     // Issue 561: Set by -DDing3d.releaseBoundingBoxMemory property.
    ...
    static {
        releaseBoundingBoxMemory = MasterControl.getBooleanProperty("Ding3d.releaseBoundingBoxMemory",
	...
	if( boundsObject == null ) {
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingBox0"));
	}
    ...
    public BoundingBox(Bounds[] bounds) {
      int i=0;
       ...
       for(;i<bounds.length;i++) {
	       ...
	       throw new IllegalArgumentException(Ding3dI18N.getString("BoundingBox1"));
	   }
       }
       updateBoundsStates();
    }
	...
	if( boundsObject.boundId == BOUNDING_BOX){
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingBox3"));
	}
    ...
    public void combine(Bounds[] bounds) {
       ...
       for(;i<bounds.length;i++) {
	      ...
	      throw new IllegalArgumentException(Ding3dI18N.getString("BoundingBox4"));
 	  }
       }
	...
	if(boundsObject.boundId == BOUNDING_BOX){
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingBox5"));
	}
   ...
   /**
	...
	if( boundsObject.boundId == BOUNDING_BOX){
	    ...
	    return intersect_ptope_abox ( (BoundingPolytope)boundsObject, this );
            ...
            throw new IllegalArgumentException(Ding3dI18N.getString("BoundingBox6"));
        }
	...
	if(boundsIsInfinite && (!boundsObject.boundsIsInfinite)) {
		...
		return false;
            ...
            throw new IllegalArgumentException(Ding3dI18N.getString("BoundingBox7"));
        }
    }
	...
	for(i = 0; i < boundsObjects.length; i++){
		...
		if( boundsObjects[i].boundId == BOUNDING_BOX){
		    ...
		    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingBox9"));
		}
	    }
	}

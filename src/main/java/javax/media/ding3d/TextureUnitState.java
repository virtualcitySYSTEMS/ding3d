...
public class TextureUnitState extends NodeComponent {
   ...
   // Array for setting default read capabilities
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("TextureUnitState0"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("TextureUnitState1"));
	...
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_STATE_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("TextureUnitState2"));
	...
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_STATE_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("TextureUnitState3"));
	...
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_STATE_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("TextureUnitState4"));
	...
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_STATE_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("TextureUnitState5"));

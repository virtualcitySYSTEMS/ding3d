...
abstract class ShaderAttributeObjectRetained extends ShaderAttributeRetained {
	 ...
	 * with an instance of <code>javax.media.ding3d.vecmath.Point3f</code>, the
	 * returned class would be <code>javax.media.ding3d.vecmath.Tuple3f</code>.
	 *
	...
	final void sendMessage(int attrMask, Object attr) {
		...
		createMessage.type = Ding3dMessage.SHADER_ATTRIBUTE_CHANGED;

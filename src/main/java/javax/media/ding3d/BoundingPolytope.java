...
import javax.media.ding3d.internal.HashCodeUtil;
...
public class BoundingPolytope extends Bounds {
	...
	if (planes.length < 4) {
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingPolytope11"));
	}
	...
	if( boundsObject.boundId == BOUNDING_SPHERE ) {
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingPolytope0"));
	}
    }
	...
	if( boundsObjects[i].boundId == BOUNDING_SPHERE ) {
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingPolytope1"));
	}
	...
	if( boundsObject == null )  {
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingPolytope2"));
	}
	...
	if( boundsObject.boundId == BOUNDING_SPHERE ) {
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingPolytope3"));
	}
	...
	for(;i<boundsObjects.length;i++) {
		...
		throw new IllegalArgumentException(Ding3dI18N.getString("BoundingPolytope4"));
	    }
	...
	if( boundsObject.boundId == BOUNDING_SPHERE ) {
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingPolytope5"));
	}
    }
	...
	if( boundsObject.boundId == BOUNDING_SPHERE ) {
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingPolytope6"));
	}
    }
	...
	for(i = 0; i < boundsObjects.length; i++){
		...
		throw new IllegalArgumentException(Ding3dI18N.getString("BoundingPolytope7"));
	    }
	}
	...
	if( boundsObject.boundId == BOUNDING_SPHERE ) {
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingPolytope8"));
	}
	...
	for(i = 0; i < boundsObjects.length; i++){
		...
		if( boundsObjects[i] instanceof BoundingSphere ) {
		    ...
		    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingPolytope10"));
		}
	    }
	}

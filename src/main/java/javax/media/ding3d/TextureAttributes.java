...
public class TextureAttributes extends NodeComponent {
   ...
   // Array for setting default read capabilities
	...
	if ((textureMode < MODULATE) || (textureMode > COMBINE)) {
	    throw new IllegalArgumentException(Ding3dI18N.getString("TextureAttributes10"));
	}

	if ((perspCorrectionMode != FASTEST) &&
	    (perspCorrectionMode!= NICEST)) {
	    throw new IllegalArgumentException(Ding3dI18N.getString("TextureAttributes9"));
	}
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("TextureAttributes0"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("TextureAttributes1"));
	...
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_BLEND_COLOR_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("TextureAttributes3"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("TextureAttributes4"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("TextureAttributes5"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("TextureAttributes6"));
	...
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_MODE_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("TextureAttributes7"));
	...
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_MODE_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("TextureAttributes8"));
    ...
    public void setTextureColorTable(int[][] table) {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_COLOR_TABLE_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("TextureAttributes11"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("TextureAttributes12"));
    ...
    public void setCombineRgbMode(int combineMode) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_COMBINE_WRITE)) {
				...
				Ding3dI18N.getString("TextureAttributes16"));
	    }
	}

        if ((combineMode < COMBINE_REPLACE) || (combineMode > COMBINE_DOT3)) {
            throw new IllegalArgumentException(
		Ding3dI18N.getString("TextureAttributes20"));
        }
    ...
    public void setCombineAlphaMode(int combineMode) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_COMBINE_WRITE)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("TextureAttributes18"));
            }
        }
	...
	if (isLiveOrCompiled()) {
		...
		throw new CapabilityNotSetException(
				Ding3dI18N.getString("TextureAttributes17"));
	    }
	}
	...
	if (isLiveOrCompiled()) {
	    if (!this.getCapability(ALLOW_COMBINE_READ)) {
		throw new CapabilityNotSetException(
				Ding3dI18N.getString("TextureAttributes19"));
	    }
	}
    ...
    public void setCombineRgbSource(int index, int src) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_COMBINE_WRITE)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("TextureAttributes21"));
            }
        }

	if ((index < 0) || (index > 2)) {
            throw new IndexOutOfBoundsException(
                Ding3dI18N.getString("TextureAttributes25"));
	}

        if ((src < COMBINE_OBJECT_COLOR) ||
		(src > COMBINE_PREVIOUS_TEXTURE_UNIT_STATE)) {
            throw new IllegalArgumentException(
                Ding3dI18N.getString("TextureAttributes26"));
        }
    ...
    public void setCombineAlphaSource(int index, int src) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_COMBINE_WRITE)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("TextureAttributes23"));
            }
        }
    ...
    public int getCombineRgbSource(int index) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_COMBINE_READ)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("TextureAttributes22"));
            }
        }
    ...
    public int getCombineAlphaSource(int index) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_COMBINE_READ)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("TextureAttributes24"));
            }
        }
    ...
    public void setCombineRgbFunction(int index, int function) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_COMBINE_WRITE)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("TextureAttributes27"));
            }
        }
        ...
        if ((function < COMBINE_SRC_COLOR) ||
            ...
            throw new IllegalArgumentException(
                Ding3dI18N.getString("TextureAttributes31"));
        }
    ...
    public void setCombineAlphaFunction(int index, int function) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_COMBINE_WRITE)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("TextureAttributes29"));
            }
        }
    ...
    public int getCombineRgbFunction(int index) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_COMBINE_READ)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("TextureAttributes28"));
            }
        }
    ...
    public int getCombineAlphaFunction(int index) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_COMBINE_READ)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("TextureAttributes30"));
            }
        }
    ...
    public void setCombineRgbScale(int scale) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_COMBINE_WRITE)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("TextureAttributes32"));
            }
        }
        ...
        if ((scale != 1) && (scale != 2) && (scale != 4)) {
            throw new IllegalArgumentException(
                Ding3dI18N.getString("TextureAttributes36"));
        }
    ...
    public void setCombineAlphaScale(int scale) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_COMBINE_WRITE)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("TextureAttributes34"));
            }
        }
    ...
    public int getCombineRgbScale() {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_COMBINE_READ)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("TextureAttributes33"));
            }
        }

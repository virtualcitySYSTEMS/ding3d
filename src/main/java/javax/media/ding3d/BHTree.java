...
class BHTree  {
	...
	if(Ding3dDebug.devPhase) {
	    if(Ding3dDebug.doDebug(Ding3dDebug.bHTree, Ding3dDebug.LEVEL_4,
	...
	if((bhArr == null) || (bhArr.length < 2) || (root == null)){
	    if(Ding3dDebug.devPhase)
		Ding3dDebug.doDebug(Ding3dDebug.bHTree, Ding3dDebug.LEVEL_1,
	...
	if(Ding3dDebug.devPhase && Ding3dDebug.debug)
	    Ding3dDebug.doDebug(Ding3dDebug.bHTree, Ding3dDebug.LEVEL_4,
	...
	if(Ding3dDebug.devPhase)
	    Ding3dDebug.doDebug(Ding3dDebug.bHTree, Ding3dDebug.LEVEL_2,

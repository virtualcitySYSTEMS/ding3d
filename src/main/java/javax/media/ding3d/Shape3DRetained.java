...
class Shape3DRetained extends LeafRetained {
    ...
    static final int targetThreads = Ding3dThread.UPDATE_RENDERING_ENVIRONMENT |
	...
	if (((Shape3D)this.source).isLive()) {
	    ...
	    createMessage[0].type = Ding3dMessage.SHAPE3D_CHANGED;
	...
	if (((Shape3D)this.source).isLive()) {
	    ...
	    createMessage.type = Ding3dMessage.SHAPE3D_CHANGED;
    ...
    boolean intersect(SceneGraphPath path,
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("Shape3DRetained3"));
	}
...
*/
   ...
   */
	...
	*/
	...
	changeMessage.type = Ding3dMessage.SHAPE3D_CHANGED;
	// Who to send this message to ?
	changeMessage.threads = Ding3dThread.UPDATE_RENDER |
	    Ding3dThread.UPDATE_TRANSFORM |
	    Ding3dThread.UPDATE_GEOMETRY;
...
0
	...
	if (geometry != null) {
		...
		if ((geomRetained != null) &&
			...
			throw new IllegalArgumentException(Ding3dI18N.getString("Shape3DRetained5"));
		    }
		    break;
		}
	    }

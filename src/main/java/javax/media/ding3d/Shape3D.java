...
public class Shape3D extends Leaf {
   ...
   // Array for setting default read capabilities
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Shape3D0"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Shape3D1"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Shape3D2"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Shape3D3"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Shape3D4"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Shape3D5"));
	...
	if (isLiveOrCompiled()) {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Shape3D6"));
	}
	...
	if (pickShape instanceof PickPoint) {
	    throw new IllegalArgumentException(Ding3dI18N.getString("Shape3D7"));
	}
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Shape3D8"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Shape3D9"));

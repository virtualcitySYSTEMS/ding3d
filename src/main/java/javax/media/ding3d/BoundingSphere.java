...
public class BoundingSphere extends Bounds {
	...
	if (boundsObject == null) {
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingSphere0"));
	}
	...
	if ((boundsObject == null) || boundsObject.boundsIsEmpty) {
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingSphere2"));
	}
	updateBoundsStates();
    }
	...
	if( boundsObject.boundId == BOUNDING_BOX){
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingSphere3"));
	}
	updateBoundsStates();
    }
	...
	for(;i<boundsObjects.length;i++) {
		...
		throw new IllegalArgumentException(Ding3dI18N.getString("BoundingSphere4"));
	    }
	}
	...
	if( boundsObject.boundId == BOUNDING_BOX){
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingSphere5"));
	}
    }
	...
	if( boundsObject.boundId == BOUNDING_BOX){
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingSphere6"));
	}
    }
	...
	for(i = 0; i < boundsObjects.length; i++){
		...
		throw new IllegalArgumentException(Ding3dI18N.getString("BoundingSphere7"));
	    }
	}
	...
	if(boundsIsInfinite && (!boundsObject.boundsIsInfinite)) {
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingSphere8"));
	}
    }
	...
	for(i=0;i<boundsObjects.length;i++) {
		...
		throw new IllegalArgumentException(Ding3dI18N.getString("BoundingSphere9"));
	    }
	}
	if( status  == false) {
	    // Negative volume.
	...
	for(i = 0; i < boundsObjects.length; i++){
		...
		if(boundsObjects[i].boundId == BOUNDING_BOX){
		    ...
		    throw new IllegalArgumentException(Ding3dI18N.getString("BoundingSphere10"));
		}
	    }
	}

...
/**
 * The Ding3dMessage is the super class of all messages in Java 3D.  It implements
 * all of the common data members needed.
 */

class Ding3dMessage extends Object {
    /**
	...
	// System.err.println("Ding3dMessage : " + this );
	view = null;
	universe = null;
	args[0] = null;
	args[1] = null;

 ...
 * <code>Ding3dAttrName</code> during rendering. <code>attrName</code>
 ...
 * a runtime error may be generated. <code>Ding3dAttrName</code> must be
 * the name of a predefined Java&nbsp;3D system attribute. An
 * IllegalArgumentException will be thrown if the specified
 * <code>Ding3dAttrName</code> is not one of the predefined system
 * attributes. Further, the type of the <code>Ding3dAttrName</code>
...
public class ShaderAttributeBinding extends ShaderAttribute {
     ...
     * <code>(attrName,&nbsp;Ding3dAttrName)</code> pair.
     *
     * @param attrName the name of the shader attribute to be added
     * @param Ding3dAttrName the name of the Java&nbsp;3D attribute
     * to bind to the shader attribute
     *
     * @exception UnsupportedOperationException this class is not
     * yet implemented
     *
     * @exception NullPointerException if attrName or Ding3dAttrName is null
     *
     * @exception IllegalArgumentException if Ding3dAttrName is not the name
     * of a valid predefined Java&nbsp;3D system attribute
     */
    public ShaderAttributeBinding(String attrName, String Ding3dAttrName) {
	super(attrName);
	((ShaderAttributeBindingRetained)this.retained).initDing3dAttrName(Ding3dAttrName);
	// TODO: implement this class
	throw new UnsupportedOperationException(Ding3dI18N.getString("ShaderAttributeBinding0"));
    }
     ...
     * shader attribute
     */
    public String getDing3dAttributeName() {
 	return ((ShaderAttributeBindingRetained)this.retained).getDing3dAttributeName();
    }

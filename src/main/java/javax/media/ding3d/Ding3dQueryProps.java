/*
 * $RCSfile: Ding3dQueryProps.java,v $
 *
 ...
 * up by a Hashtable.
 */
class Ding3dQueryProps extends AbstractMap {
    private Hashtable table;
    private Set entrySet = null;


    /**
     * Constructs a new Ding3dQueryProps object using the specified
     * array of keys and the specified values.  The arrays must be
     * the same size.
     */
    Ding3dQueryProps(String[] keys, Object[] values) {
	table = new Hashtable();

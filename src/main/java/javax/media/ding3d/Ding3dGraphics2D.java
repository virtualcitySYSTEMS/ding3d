/*
 * $RCSfile: Ding3dGraphics2D.java,v $
 *
 ...
 *
 * <p>
 * An application obtains a Ding3d 2D graphics context object from the
 * Canvas3D object that the application wishes to render into by using
 * the getGraphics2D method. A new Ding3dGraphics2D object is created if
...
public abstract class Ding3dGraphics2D extends Graphics2D {
     ...
     * Ding3dGraphics2D is from the associated Canvas3D.
     *
     ...
     * previously drawn to this Ding3dGraphics2D will be flushed before
     * the image is drawn.
     *

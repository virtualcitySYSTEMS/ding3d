...
public class RotPosScalePathInterpolator extends PathInterpolator {
	...
	if (knots.length != quats.length)
	    throw new IllegalArgumentException(Ding3dI18N.getString("RotPosScalePathInterpolator1"));

	if (knots.length != positions.length)
	    throw new IllegalArgumentException(Ding3dI18N.getString("RotPosScalePathInterpolator0"));

	if (knots.length != scales.length)
	    throw new IllegalArgumentException(Ding3dI18N.getString("RotPosScalePathInterpolator2"));

...
public abstract class Texture extends NodeComponent {
    ...
    public Texture(int		mipMapMode,
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("Texture0"));

	if ((format != INTENSITY) && (format != LUMINANCE) &&
	    (format != ALPHA) && (format != LUMINANCE_ALPHA) &&
	    (format != RGB) && (format != RGBA)) {
	    throw new IllegalArgumentException(Ding3dI18N.getString("Texture1"));
	}

        if (width < 1) {
            throw new IllegalArgumentException(Ding3dI18N.getString("Texture46"));
        }

        if (height < 1) {
            throw new IllegalArgumentException(Ding3dI18N.getString("Texture47"));
        }
	...
	public String getSourceUri() {
		return ((TextureRetained)this.retained).getSourceUri();
	}

	public void setSourceUri(String sourceUri) {
		((TextureRetained)this.retained).setSourceUri(sourceUri);
	}
	...
	if (boundaryWidth < 0 || boundaryWidth > 1)
	    throw new IllegalArgumentException(Ding3dI18N.getString("Texture30"));
	...
	switch (boundaryModeS) {
	    ...
	    break;
	default:
	    throw new IllegalArgumentException(Ding3dI18N.getString("Texture31"));
	}
    ...
    public int getBoundaryModeS() {
        if (isLiveOrCompiled())
            if(!this.getCapability(ALLOW_BOUNDARY_MODE_READ))
              throw new CapabilityNotSetException(Ding3dI18N.getString("Texture4"));
	...
	case FILTER4:
	    break;
	default:
	    throw new IllegalArgumentException(Ding3dI18N.getString("Texture28"));
	}
    ...
    public int getMinFilter() {
        if (isLiveOrCompiled())
            if(!this.getCapability(ALLOW_FILTER_READ))
              throw new CapabilityNotSetException(Ding3dI18N.getString("Texture6"));
	...
	case FILTER4:
	    break;
	default:
	    throw new IllegalArgumentException(Ding3dI18N.getString("Texture29"));
	}
    ...
    public void setImage(int level, ImageComponent image) {
	  ...
	  if(!this.getCapability(ALLOW_IMAGE_WRITE))
	    throw new CapabilityNotSetException(Ding3dI18N.getString("Texture15"));
	}
    ...
    public ImageComponent getImage(int level) {
	  ...
	  if(!this.getCapability(ALLOW_IMAGE_READ))
	    throw new CapabilityNotSetException(Ding3dI18N.getString("Texture9"));
	}
	...
	if (images == null)
	    throw new IllegalArgumentException(Ding3dI18N.getString("Texture20"));
    ...
    public int getFormat() {
        if (isLiveOrCompiled()) {
            if(!this.getCapability(ALLOW_FORMAT_READ))
              throw new CapabilityNotSetException(Ding3dI18N.getString("Texture19"));
	}
    ...
    public int getWidth() {
        if (isLiveOrCompiled()) {
            if(!this.getCapability(ALLOW_SIZE_READ))
              throw new CapabilityNotSetException(Ding3dI18N.getString("Texture16"));
	}
    ...
    public int getHeight() {
        if (isLiveOrCompiled()) {
            if(!this.getCapability(ALLOW_SIZE_READ))
              throw new CapabilityNotSetException(Ding3dI18N.getString("Texture17"));
	}
    ...
    public int numMipMapLevels() {
        if (isLiveOrCompiled()) {
            if(!this.getCapability(ALLOW_SIZE_READ))
              throw new CapabilityNotSetException(Ding3dI18N.getString("Texture18"));
	}
    ...
    public int getMipMapMode() {
        if (isLiveOrCompiled())
            if(!this.getCapability(ALLOW_MIPMAP_MODE_READ))
              throw new CapabilityNotSetException(Ding3dI18N.getString("Texture10"));
    ...
    public void setEnable(boolean state) {
        if (isLiveOrCompiled()) {
            if(!this.getCapability(ALLOW_ENABLE_WRITE))
              throw new CapabilityNotSetException(Ding3dI18N.getString("Texture11"));
	}
	if (isLive())
    ...
    public boolean getEnable() {
        if (isLiveOrCompiled()) {
            if(!this.getCapability(ALLOW_ENABLE_READ))
              throw new CapabilityNotSetException(Ding3dI18N.getString("Texture12"));
	}
	return ((TextureRetained)this.retained).getEnable();
    }

    // Internal Ding3d usage method
    ...
    public void getBoundaryColor(Color4f boundaryColor) {
        if (isLiveOrCompiled()) {
            if(!this.getCapability(ALLOW_BOUNDARY_COLOR_READ))
              throw new CapabilityNotSetException(Ding3dI18N.getString("Texture13"));
	}
	...
	if (isLiveOrCompiled()) {
		...
		throw new CapabilityNotSetException(
				Ding3dI18N.getString("Texture34"));
	    }
        }
    ...
    public void setMaximumLevel(int maximumLevel) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_LOD_RANGE_WRITE)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("Texture33"));
            }
        }
	...
	if (isLiveOrCompiled()) {
	    if (!this.getCapability(ALLOW_LOD_RANGE_READ)) {
		throw new CapabilityNotSetException(
				Ding3dI18N.getString("Texture35"));
	    }
        }
    ...
    public void setMinimumLOD(float minimumLod) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_LOD_RANGE_WRITE)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("Texture38"));
            }
        }
    ...
    public float getMinimumLOD() {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_LOD_RANGE_READ)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("Texture40"));
            }
        }
    ...
    public void setMaximumLOD(float maximumLod) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_LOD_RANGE_WRITE)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("Texture39"));
            }
        }
    ...
    public float getMaximumLOD() {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_LOD_RANGE_READ)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("Texture41"));
            }
        }
    ...
    public void setLodOffset(float s, float t, float r) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_LOD_RANGE_WRITE)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("Texture44"));
            }
        }
    ...
    public void getLodOffset(Tuple3f offset) {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_LOD_RANGE_READ)) {
                throw new CapabilityNotSetException(
                                Ding3dI18N.getString("Texture45"));
            }
        }
	...
	checkForLiveOrCompiled();
		...
		(mode != ANISOTROPIC_SINGLE_VALUE)) {
	     throw new IllegalArgumentException(
                        Ding3dI18N.getString("Texture25"));
	}
	...
	if (isLiveOrCompiled()) {
		...
		throw new CapabilityNotSetException(
				Ding3dI18N.getString("Texture26"));
	    }
	}
	...
	checkForLiveOrCompiled();
        if (degree < 1.0) {
	    throw new IllegalArgumentException(
                        Ding3dI18N.getString("Texture27"));
	}
    ...
    public int getSharpenTextureFuncPointsCount() {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_SHARPEN_TEXTURE_READ)) {
                throw new CapabilityNotSetException(
				Ding3dI18N.getString("Texture21"));
	    }
        }
	...
	if ((weights == null) || (weights.length < 4)) {
	    throw new IllegalArgumentException(
			Ding3dI18N.getString("Texture24"));
	} else {
    ...
    public int getFilter4FuncPointsCount() {
        if (isLiveOrCompiled()) {
            if (!this.getCapability(ALLOW_FILTER4_READ)) {
                throw new CapabilityNotSetException(
				Ding3dI18N.getString("Texture23"));
	    }
        }

...
class Ding3dClock {
    ...
    // and corrected. false by default. Set by the "Ding3d.adjustClockSkew" property.
    ...
    static long currentTimeMillis() {
        if (!skewAdjustedClock) {
            ...
            if (Math.abs(time - sysTime) > 50) {
                ...
                synchronized (Ding3dClock.class) {
    ...
    static {
        ...
        skewAdjustedClock = MasterControl.getBooleanProperty("Ding3d.adjustClockSkew",

...
class ImageComponent2DRetained extends ImageComponentRetained {
    ...
    void set(NioImageBuffer image) {
        ...
        if (!byReference) {
            throw new IllegalArgumentException(Ding3dI18N.getString("ImageComponent2D7"));
        }
        if (!yUp) {
            throw new IllegalArgumentException(Ding3dI18N.getString("ImageComponent2D8"));
        }

        if (width != this.width) {
            throw new IllegalArgumentException(Ding3dI18N.getString("ImageComponent2DRetained0"));
        }
        if (height != this.height) {
            throw new IllegalArgumentException(Ding3dI18N.getString("ImageComponent2DRetained1"));
        }
    ...
    NioImageBuffer getNioImage() {
        ...
        if (getImageClass() != ImageComponent.ImageClass.NIO_IMAGE_BUFFER) {
             throw new IllegalStateException(Ding3dI18N.getString("ImageComponent2D9"));
        }

...
public abstract class SceneGraphObject extends Object {
   // Any global flags? (e.g., execution cullable, collideable)
	...
	if (isLiveOrCompiled()) {
            throw new RestrictedAccessException(Ding3dI18N.getString("SceneGraphObject0"));
	}
	...
	if (isCompiled())
            throw new RestrictedAccessException(Ding3dI18N.getString("SceneGraphObject1"));
	...
	if (isLiveOrCompiled())
	    throw new RestrictedAccessException(Ding3dI18N.getString("SceneGraphObject2"));
    }

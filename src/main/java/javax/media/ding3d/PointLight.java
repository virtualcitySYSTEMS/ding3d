  ...
  */
   ...
   */
    public void setPosition(Point3f position) {
	  ...
	  if(!this.getCapability(ALLOW_POSITION_WRITE))
	      throw new CapabilityNotSetException(Ding3dI18N.getString("PointLight0"));
   ...
   */
    public void setPosition(float x, float y, float z) {
      if (isLiveOrCompiled())
	  if(!this.getCapability(ALLOW_POSITION_WRITE))
	      throw new CapabilityNotSetException(Ding3dI18N.getString("PointLight1"));
    ...
    public void getPosition(Point3f position) {
        if (isLiveOrCompiled())
 	    if(!this.getCapability(ALLOW_POSITION_READ))
	        throw new CapabilityNotSetException(Ding3dI18N.getString("PointLight2"));
   ...
   */
    public void setAttenuation(Point3f attenuation) {
	  ...
	  if(!this.getCapability(ALLOW_ATTENUATION_WRITE))
	      throw new CapabilityNotSetException(Ding3dI18N.getString("PointLight3"));
   ...
   */
    public void getAttenuation(Point3f attenuation) {
	    ...
	    if(!this.getCapability(ALLOW_ATTENUATION_READ))
	        throw new CapabilityNotSetException(Ding3dI18N.getString("PointLight5"));

...
class InputDeviceScheduler extends Ding3dThread {
    ...
    InputDeviceScheduler(ThreadGroup threadGroup,
			 PhysicalEnvironment physicalEnv) {
	super(threadGroup);
	setName("Ding3d-InputDeviceScheduler-" + getInstanceNum());
	threadData.threadType = Ding3dThread.INPUT_DEVICE_SCHEDULER;
    ...
    Ding3dThreadData getThreadData() {
	return threadData;
    }

/*
 * $RCSfile: Ding3dThreadData.java,v $
 *
...
/**
 * The Ding3dThreadData is the data wrapper for threads in Java 3D.
 */

class Ding3dThreadData extends Object {
    /**
     * Thread run options
     */

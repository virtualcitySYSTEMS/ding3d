/*
 * $RCSfile: Ding3dNodeTable.java,v $
 *
...
/**
 * The Ding3dNodeTable object provides utilities for the save/load
...
class Ding3dNodeTable {
    ...
    // Problem: these next two are non Ding3d-core items
	...
	try {
		...
		String nodeName = "javax.media.ding3d." + nodeArray[nodeValue];

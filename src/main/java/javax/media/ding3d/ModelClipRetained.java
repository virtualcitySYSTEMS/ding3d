...
class ModelClipRetained extends LeafRetained {
    ...
    void initPlane(int planeNum, Vector4d plane) {
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("ModelClip6"));
   ...
   void initRemoveScope(Group node) {
	...
	if (inSharedGroup) {
	    throw new
		IllegalSharingException(Ding3dI18N.getString("ModelClipRetained1"));
	}
	...
	createMessage.type = Ding3dMessage.MODELCLIP_CHANGED;

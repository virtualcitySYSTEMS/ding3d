...
public abstract class NodeComponent extends SceneGraphObject {
   ...
   */
	...
	throw new RuntimeException(Ding3dI18N.getString("NodeComponent0"));
    }
    ...
    void duplicateAttributes(NodeComponent originalNode,
        ...
        if (forceDuplicate && originalNode.isCompiled()) {
            throw new RestrictedAccessException(
                Ding3dI18N.getString("NodeComponent1"));
        }
       ...
       // Do illegal sharing check
        if(image != null) {
            ...
            if(imageRetained.getUsedByOffScreen()) {
                if(isLive()) {
                    throw new IllegalSharingException(Ding3dI18N.getString("NodeComponent2"));
                }
                if(ncRetained.getInImmCtx()) {
                    throw new IllegalSharingException(Ding3dI18N.getString("NodeComponent3"));
                }
            }
        }
   }

...
public class ShaderAttributeSet extends NodeComponent {
   ...
   // Array for setting default read capabilities
	...
	if (attr == null) {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("ShaderAttributeSet1"));
    ...
    public ShaderAttribute get(String attrName) {
 	...
 	if (attrName == null) {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("ShaderAttributeSet0"));

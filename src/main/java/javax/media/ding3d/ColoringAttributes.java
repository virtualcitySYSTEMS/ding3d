...
public class ColoringAttributes extends NodeComponent {
   ...
   // Array for setting default read capabilities
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("ColoringAttributes0"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("ColoringAttributes2"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("ColoringAttributes3"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("ColoringAttributes4"));
    ...
    public String toString() {
        ...
        str.append("javax.media.ding3d.ColoringAttributes: ");

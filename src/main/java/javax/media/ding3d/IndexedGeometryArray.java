...
public abstract class IndexedGeometryArray extends GeometryArray {
  ...
  public int getIndexCount(){
    if (isLiveOrCompiled())
        if(!this.getCapability(GeometryArray.ALLOW_COUNT_READ))
          throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryArray0"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryArray16"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryArray17"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_COUNT_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryArray18"));

        if (initialIndexIndex < 0)
	    throw new IllegalArgumentException(Ding3dI18N.getString("IndexedGeometryArray20"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_COUNT_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryArray19"));
  ...
  public void setCoordinateIndex(int index, int coordinateIndex) {
    ...
    if(!this.getCapability(ALLOW_COORDINATE_INDEX_WRITE))
      throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryArray1"));

    //NVaidya
    int format = ((IndexedGeometryArrayRetained)this.retained).vertexFormat;
    if ((format & BY_REFERENCE_INDICES) != 0)
      throw new IllegalStateException(Ding3dI18N.getString("IndexedGeometryArray31"));
  ...
  public void setCoordinateIndices(int index, int coordinateIndices[]) {
    ...
    public void setCoordIndicesRef(int coordIndices[]) {
        ...
        int format = ((IndexedGeometryArrayRetained)this.retained).vertexFormat;
        if ((format & BY_REFERENCE_INDICES) == 0)
            throw new IllegalStateException(Ding3dI18N.getString("IndexedGeometryArray32"));
  ...
  public void setColorIndex(int index, int colorIndex) {
    ...
    if(!this.getCapability(ALLOW_COLOR_INDEX_WRITE))
      throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryArray3"));
  ...
  public void setNormalIndex(int index, int normalIndex) {
    ...
    if(!this.getCapability(ALLOW_NORMAL_INDEX_WRITE))
      throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryArray5"));
  ...
  public void setNormalIndices(int index, int normalIndices[]) {
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryArray7"));
	...
	if (isLiveOrCompiled()) {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryArray28"));
            }
        }
  ...
  public int getCoordinateIndex(int index) {
    if (isLiveOrCompiled())
        if(!this.getCapability(ALLOW_COORDINATE_INDEX_READ))
      	   throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryArray9"));
  ...
  public int getColorIndex(int index) {
    ...
    if(!this.getCapability(ALLOW_COLOR_INDEX_READ))
      throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryArray11"));
  ...
  public void getNormalIndices(int index, int normalIndices[]) {
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_COORDINATE_INDEX_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryArray15"));
	...
	if (isLiveOrCompiled()) {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryArray29"));
            }
        }

...
abstract class Pipeline {
    ...
    private static final String CLASSNAME_NATIVE = "javax.media.ding3d.NativePipeline";
    private static final String CLASSNAME_JOGL = "javax.media.ding3d.JoglPipeline";
    private static final String CLASSNAME_NOOP = "javax.media.ding3d.NoopPipeline";
...
//        }
//
//   //     System.out.println("createPipeline "+className);
//
...
//        pipeline.initialize(pipelineType);
  ...
  //      System.out.println("setPipelineType "+pipelineType);
    }
    ...
    */
    ...
    // Method to initialize the native Ding3d library
    abstract boolean initializeDing3d(boolean disableXinerama);

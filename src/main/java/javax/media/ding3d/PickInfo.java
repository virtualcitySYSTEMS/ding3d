   ...
   */
    ...
    static PickInfo[] pick(Object node, GeometryAtom[] geomAtoms,
	   ...
	   ((pickInfoListSize = pickInfoList.size()) > 0)) {
			...
			throw new CapabilityNotSetException(Ding3dI18N.getString("PickInfo0"));
		    }
			...
			if(!geo.getCapability(Geometry.ALLOW_INTERSECT)) {
			    throw new CapabilityNotSetException(Ding3dI18N.getString("PickInfo1"));
			}

			if (geo instanceof GeometryArray) {
			    if(!geo.getCapability(GeometryArray.ALLOW_COORDINATE_READ))
				throw new CapabilityNotSetException(Ding3dI18N.getString("PickInfo2"));
			    if(!geo.getCapability(GeometryArray.ALLOW_COUNT_READ))
				throw new CapabilityNotSetException(Ding3dI18N.getString("PickInfo3"));
			    if(!geo.getCapability(GeometryArray.ALLOW_FORMAT_READ))
				throw new CapabilityNotSetException(Ding3dI18N.getString("PickInfo4"));
			    if (geo instanceof IndexedGeometryArray) {
				if(!geo.getCapability(IndexedGeometryArray.ALLOW_COORDINATE_INDEX_READ))
				    throw new CapabilityNotSetException(Ding3dI18N.getString("PickInfo5"));
			    }
			...
			throw new CapabilityNotSetException(Ding3dI18N.getString("PickInfo6"));
		    }

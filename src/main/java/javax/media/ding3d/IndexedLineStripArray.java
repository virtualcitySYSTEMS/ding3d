...
public class IndexedLineStripArray extends IndexedGeometryStripArray {
	...
	super(vertexCount, vertexFormat, indexCount, stripIndexCounts);
        ...
        if (vertexCount < 1)
	    throw new IllegalArgumentException(Ding3dI18N.getString("IndexedLineStripArray0"));

        if (indexCount < 2 )
	    throw new IllegalArgumentException(Ding3dI18N.getString("IndexedLineStripArray1"));
    }

   ...
   // Array for setting default read capabilities
    ...
    public Background(ImageComponent2D image) {
        ...
        if((image != null) &&
            ...
            throw new IllegalArgumentException(Ding3dI18N.getString("Background14"));
        }
    ...
    public void setColor(Color3f color) {
        if (isLiveOrCompiled())
         if(!this.getCapability(ALLOW_COLOR_WRITE))
           throw new CapabilityNotSetException(Ding3dI18N.getString("Background0"));
    ...
    public void getColor(Color3f color) {
        if (isLiveOrCompiled())
         if(!this.getCapability(ALLOW_COLOR_READ))
           throw new CapabilityNotSetException(Ding3dI18N.getString("Background2"));
    ...
    public void setImage(ImageComponent2D image) {
        if (isLiveOrCompiled())
         if(!this.getCapability(ALLOW_IMAGE_WRITE))
           throw new CapabilityNotSetException(Ding3dI18N.getString("Background3"));
        ...
        if(image != null) {
            ...
            if(imageRetained.getUsedByOffScreen()) {
                if(isLive()) {
                    throw new IllegalSharingException(Ding3dI18N.getString("Background12"));
                }
                if(bgRetained.getInImmCtx()) {
                    throw new IllegalSharingException(Ding3dI18N.getString("Background13"));
                }
            }
        }
    ...
    public ImageComponent2D getImage() {
        if (isLiveOrCompiled())
         if(!this.getCapability(ALLOW_IMAGE_READ))
           throw new CapabilityNotSetException(Ding3dI18N.getString("Background4"));
    ...
    public void setImageScaleMode(int imageScaleMode) {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Background9"));
	...
	case SCALE_NONE_CENTER:
	    break;
	default:
	    throw new IllegalArgumentException(Ding3dI18N.getString("Background11"));
	}
    ...
    public int getImageScaleMode() {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Background10"));
    ...
    public void setGeometry(BranchGroup branch) {
        if (isLiveOrCompiled())
         if(!this.getCapability(ALLOW_GEOMETRY_WRITE))
           throw new CapabilityNotSetException(Ding3dI18N.getString("Background5"));
    ...
    public BranchGroup getGeometry() {
        if (isLiveOrCompiled())
         if(!this.getCapability(ALLOW_GEOMETRY_READ))
           throw new CapabilityNotSetException(Ding3dI18N.getString("Background6"));
    ...
    public void setApplicationBounds(Bounds region) {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Background7"));
    ...
    public Bounds getApplicationBounds() {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Background8"));

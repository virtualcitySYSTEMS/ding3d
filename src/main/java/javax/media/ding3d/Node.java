...
public abstract class Node extends SceneGraphObject {
   ...
   // Array for setting default read capabilities
	...
	if (isLiveOrCompiled()) {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Node0"));
	    }
	}
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Node1"));
	...
	if (isLiveOrCompiled()) {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Node2"));
	    }
	}
	else {
   ...
   /**
    ...
    public boolean getCollidable() {
        if (isLiveOrCompiled())
            if(!this.getCapability(ALLOW_COLLIDABLE_READ))
                throw new CapabilityNotSetException(Ding3dI18N.getString("Node16"));
    ...
    public void setCollidable( boolean collidable ) {
        if (isLiveOrCompiled())
            if(!this.getCapability(ALLOW_COLLIDABLE_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("Node4"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Node5"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Node6"));
    ...
    public void getLocalToVworld(Transform3D t) {
        if (isLiveOrCompiled()) {
            if(!this.getCapability(ALLOW_LOCAL_TO_VWORLD_READ))
                    throw new CapabilityNotSetException(Ding3dI18N.getString("Node8"));
        }

	if (!isLive()) {
            // TODO Support compiled graphs
            if (isCompiled())
                throw new RestrictedAccessException(Ding3dI18N.getString("Node7"));
	...
	if(!this.getCapability(ALLOW_LOCALE_READ)) {
	    throw new CapabilityNotSetException(Ding3dI18N.getString("Node17"));
	}
   ...
   /**
     ...
     */
    public Node cloneNode(boolean forceDuplicate) {
        throw new RuntimeException(Ding3dI18N.getString("Node12"));
    }
   ...
   /**
	...
	if (originalNode.isLiveOrCompiled()) {
	    throw new RestrictedAccessException(Ding3dI18N.getString("Node13"));
	}
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Node14"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Node3"));
    ...
    void checkForCycle() {
	if (visited) {
	    throw new SceneGraphCycleException(Ding3dI18N.getString("Node15"));
	}
	visited = true;

...
class Ding3dDebug  {
    ...
    static final int Ding3dDataInputStream = !devPhase?NO_DEBUG:NO_DEBUG;
    static final int Ding3dDataOutputStream = !devPhase?NO_DEBUG:NO_DEBUG;
    static final int Ding3dDebug = !devPhase?NO_DEBUG:NO_DEBUG;
    static final int Ding3dI18N = !devPhase?NO_DEBUG:NO_DEBUG;
    static final int Ding3dMessage = !devPhase?NO_DEBUG:NO_DEBUG;
    static final int Ding3dNodeTable = !devPhase?NO_DEBUG:NO_DEBUG;
    static final int Ding3dQueryProps = !devPhase?NO_DEBUG:NO_DEBUG;
    static final int Ding3dStructure = !devPhase?NO_DEBUG:NO_DEBUG;
    static final int Ding3dThread = !devPhase?NO_DEBUG:NO_DEBUG;
    static final int Ding3dThreadData = !devPhase?NO_DEBUG:NO_DEBUG;
    ...
    static final int transformStructure = !devPhase?NO_DEBUG:LEVEL_3;
    ...
    static boolean doDebug(int Ding3dClassLevel, int level, String str) {
	if(Ding3dClassLevel >= level) {
    ...
    static boolean doDebug(int Ding3dClassLevel, int level) {
	if(Ding3dClassLevel >= level) {
	    return true;
	}
	return false;

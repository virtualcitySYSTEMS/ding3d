...
public class Morph extends Leaf {
   ...
   // Array for setting default read capabilities
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Morph0"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Morph1"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Morph2"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Morph3"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Morph4"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Morph5"));
	...
	if (pickShape instanceof PickPoint) {
	    throw new IllegalArgumentException(Ding3dI18N.getString("Morph10"));
	}
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Morph8"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Morph9"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Morph11"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Morph12"));
   ...
   /**
	...
	for (int i = 0; i < numGeometryArrays; i++) {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Morph6"));
	    }
	}
    }

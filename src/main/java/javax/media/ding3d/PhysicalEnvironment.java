...
////    Vector3d nondominantHandTrackerHotspotOffset;
    ...
    public void addInputDevice(InputDevice device) {
        ...
        if ((driver_type == InputDevice.BLOCKING) ||
            ...
            throw new IllegalArgumentException(Ding3dI18N.getString("PhysicalEnvironment0"));
        }
    }
	...
	if (!t.isRigid()) {
	    throw new BadTransformException(Ding3dI18N.getString("PhysicalEnvironment1"));
	}
	synchronized(this) {
	...
	default:
	    throw new IllegalArgumentException(Ding3dI18N.getString("PhysicalEnvironment2"));
	}

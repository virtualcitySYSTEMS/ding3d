...
abstract class SoundRetained extends LeafRetained
{
    ...
    */
    ...
    static final int targetThreads = Ding3dThread.UPDATE_SOUND |
    ...
    void dispatchAttribChange(int dirtyBit, Object argument) {
        ...
        createMessage.threads = Ding3dThread.UPDATE_SOUND |
                                Ding3dThread.SOUND_SCHEDULER;
        createMessage.type = Ding3dMessage.SOUND_ATTRIB_CHANGED;
    ...
    void dispatchStateChange(int dirtyBit, Object argument) {
        ...
        createMessage.threads = Ding3dThread.UPDATE_SOUND |
                                Ding3dThread.SOUND_SCHEDULER;
        createMessage.type = Ding3dMessage.SOUND_STATE_CHANGED;
        createMessage.universe = universe;
        createMessage.args[0] = this;
        createMessage.args[1]= new Integer(dirtyBit);
        if (inSharedGroup)
...
// XXXX: copy ms.atoms array from this.atoms
	...
	if (inImmCtx) {
            throw new
               IllegalSharingException(Ding3dI18N.getString("SoundRetained2"));
        }
        super.setLive(s);
        if (inBackgroundGroup) {
             throw new
                IllegalSceneGraphException(Ding3dI18N.getString("SoundRetained3"));
        }

...
public abstract class IndexedGeometryStripArray extends IndexedGeometryArray {
   ...
   */
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryStripArray0"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryStripArray2"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(GeometryArray.ALLOW_COUNT_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("IndexedGeometryStripArray1"));

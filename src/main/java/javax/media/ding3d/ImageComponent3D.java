...
public class ImageComponent3D extends ImageComponent {
    ...
    public int getDepth() {
        if (isLiveOrCompiled())
            if(!this.getCapability(ImageComponent.ALLOW_SIZE_READ))
              throw new CapabilityNotSetException(Ding3dI18N.getString("ImageComponent3D0"));
    ...
    public void set(int index, BufferedImage image) {
        ...
        if (image.getWidth(null) != this.getWidth())
            throw new IllegalArgumentException(Ding3dI18N.getString("ImageComponent3D2"));

	if (image.getHeight(null) != this.getHeight())
            throw new IllegalArgumentException(Ding3dI18N.getString("ImageComponent3D4"));
    ...
    public BufferedImage[] getImage() {
        if (isLiveOrCompiled())
            if(!this.getCapability(ImageComponent.ALLOW_IMAGE_READ))
              throw new CapabilityNotSetException(Ding3dI18N.getString("ImageComponent3D3"));
	...
	if ((img != null) && !(img instanceof BufferedImage)) {
	    throw new IllegalStateException(Ding3dI18N.getString("ImageComponent3D9"));
	}
    ...
    public void setSubImage(int index, RenderedImage image,
        ...
        if (isLiveOrCompiled() &&
            ...
            throw new CapabilityNotSetException(
                                Ding3dI18N.getString("ImageComponent3D5"));
        }

        if (((ImageComponent3DRetained)this.retained).isByReference()) {
            throw new IllegalStateException(
                                Ding3dI18N.getString("ImageComponent3D8"));
        }
        ...
        if ((srcX < 0) || (srcY < 0) ||
            ...
            throw new IllegalArgumentException(
                                Ding3dI18N.getString("ImageComponent3D7"));
        }
    ...
    public void updateData(Updater updater, int index,
        ...
        if (!((ImageComponent3DRetained)this.retained).isByReference()) {
            throw new IllegalStateException(
                                Ding3dI18N.getString("ImageComponent3D6"));
        }

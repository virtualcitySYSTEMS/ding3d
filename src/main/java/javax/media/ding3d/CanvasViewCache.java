...
class CanvasViewCache extends Object {
	...
	void getCanvasPositionAndSize() {
		if(Ding3dDebug.canvasViewCache >= Ding3dDebug.LEVEL_2) {
		...
		if (Ding3dDebug.canvasViewCache >= Ding3dDebug.LEVEL_1) {
			System.err.println("Canvas pos = (" + awtCanvasX + ", " +
					awtCanvasY + "), size = " + awtCanvasWidth +
					"x" + awtCanvasHeight);
		}
	...
	synchronized void computeDerivedData(boolean currentFlag,
		...
		if((Ding3dDebug.devPhase) && (Ding3dDebug.canvasViewCache >= Ding3dDebug.LEVEL_1)) {
	...
	private void doComputeDerivedData(boolean currentFlag,
		...
		if((Ding3dDebug.devPhase) && (Ding3dDebug.canvasViewCache >= Ding3dDebug.LEVEL_2)) {
			if(cvcDirtyMask != 0)

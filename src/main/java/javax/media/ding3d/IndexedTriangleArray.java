...
public class IndexedTriangleArray extends IndexedGeometryArray {
	...
	super(vertexCount,vertexFormat, indexCount);
        ...
        if (vertexCount < 1)
	    throw new IllegalArgumentException(Ding3dI18N.getString("IndexedTriangleArray0"));

        if (indexCount < 3 || ((indexCount%3) != 0))
	    throw new IllegalArgumentException(Ding3dI18N.getString("IndexedTriangleArray1"));
    }

   ...
   // Array for setting default read capabilities
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_MATERIAL_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance0"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_MATERIAL_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance1"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_COLORING_ATTRIBUTES_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance6"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_COLORING_ATTRIBUTES_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance7"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_TRANSPARENCY_ATTRIBUTES_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance8"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_TRANSPARENCY_ATTRIBUTES_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance9"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_RENDERING_ATTRIBUTES_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance10"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_RENDERING_ATTRIBUTES_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance11"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_POLYGON_ATTRIBUTES_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance12"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_POLYGON_ATTRIBUTES_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance13"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_LINE_ATTRIBUTES_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance14"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_LINE_ATTRIBUTES_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance15"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_POINT_ATTRIBUTES_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance16"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_POINT_ATTRIBUTES_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance17"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_TEXTURE_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance2"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_TEXTURE_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance3"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_TEXTURE_ATTRIBUTES_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance4"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_TEXTURE_ATTRIBUTES_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance5"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_TEXGEN_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance18"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_TEXGEN_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance19"));
    ...
    public void setTextureUnitState(TextureUnitState[] stateArray) {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_TEXTURE_UNIT_STATE_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance20"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_TEXTURE_UNIT_STATE_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Appearance21"));

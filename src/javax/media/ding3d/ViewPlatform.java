...
public class ViewPlatform extends Leaf {
   ...
   // Array for setting default read capabilities
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("ViewPlatform0"));
	...
	default:
	    throw new IllegalArgumentException(Ding3dI18N.getString("ViewPlatform1"));
	}
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("ViewPlatform2"));

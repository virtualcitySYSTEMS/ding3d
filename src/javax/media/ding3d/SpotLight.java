  ...
  public static final int
   ...
   // Array for setting default read capabilities
	...
	if (isLiveOrCompiled())
		...
		throw new
		    CapabilityNotSetException(Ding3dI18N.getString("SpotLight1"));
    ...
    public void setConcentration(float concentration) {
	  ...
	  if(!this.getCapability(ALLOW_CONCENTRATION_WRITE))
	      throw new CapabilityNotSetException(Ding3dI18N.getString("SpotLight2"));
	...
	if (isLiveOrCompiled())
		...
		throw new
		    CapabilityNotSetException(Ding3dI18N.getString("SpotLight3"));
	...
	if (isLiveOrCompiled())
		...
		throw new
		    CapabilityNotSetException(Ding3dI18N.getString("SpotLight4"));
	...
	if (isLiveOrCompiled())
		...
		throw new
		    CapabilityNotSetException(Ding3dI18N.getString("SpotLight6"));

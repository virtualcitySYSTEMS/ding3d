...
public class ModelClip extends Leaf {
   ...
   // Array for setting default read capabilities
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("ModelClip0"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("ModelClip1"));
    ...
    public BoundingLeaf getInfluencingBoundingLeaf() {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_INFLUENCING_BOUNDS_READ))
                throw new CapabilityNotSetException(Ding3dI18N.getString("ModelClip14"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("ModelClip8"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_SCOPE_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("ModelClip9"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_SCOPE_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("ModelClip10"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_SCOPE_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("ModelClip11"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_SCOPE_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("ModelClip12"));
    ...
    public void getPlanes(Vector4d[] planes) {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_PLANE_READ))
                throw new CapabilityNotSetException(Ding3dI18N.getString("ModelClip3"));
    ...
    public void setEnables(boolean[] enables) {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_ENABLE_WRITE))
                throw new CapabilityNotSetException(Ding3dI18N.getString("ModelClip4"));
    ...
    public void getEnables(boolean[] enables) {
        if (isLiveOrCompiled())
            if (!this.getCapability(ALLOW_ENABLE_READ))
                throw new CapabilityNotSetException(Ding3dI18N.getString("ModelClip5"));

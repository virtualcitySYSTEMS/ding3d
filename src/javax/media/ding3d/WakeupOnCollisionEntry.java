...
public final class WakeupOnCollisionEntry extends WakeupCriterion {
  ...
  // different types of WakeupIndexedList that use in GeometryStructure
	...
	if (behav == null) {
	    throw new IllegalStateException(Ding3dI18N.getString("WakeupOnCollisionEntry5"));
	}

	synchronized (behav) {
	    if (!behav.inCallback) {
		throw new IllegalStateException
		    (Ding3dI18N.getString("WakeupOnCollisionEntry5"));
	    }
	}
	...
	if (behav == null) {
	    throw new IllegalStateException(Ding3dI18N.getString("WakeupOnCollisionEntry6"));
	}

	synchronized (behav) {
	    if (!behav.inCallback) {
		throw new IllegalStateException
		    (Ding3dI18N.getString("WakeupOnCollisionEntry6"));
	    }
	}
	...
	if (!armingPath.validate()) {
	    throw new IllegalArgumentException(Ding3dI18N.getString(s + "7"));
	}

	if (armingNode.inBackgroundGroup) {
	    throw new IllegalArgumentException(Ding3dI18N.getString(s + "1"));
	}
	...
	throw new IllegalArgumentException(Ding3dI18N.getString(s + "0"));
    }
	...
	if ((speedHint != USE_GEOMETRY) && (speedHint != USE_BOUNDS)) {
	    throw new IllegalArgumentException(Ding3dI18N.getString(s));
	}

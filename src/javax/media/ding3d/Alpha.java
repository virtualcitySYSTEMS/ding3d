...
public class Alpha extends NodeComponent {
	...
	*/
     ...
     */
    public void pause() {
	pause(Ding3dClock.currentTimeMillis());
    }
	...
	if (time <= 0L) {
	    throw new IllegalArgumentException(Ding3dI18N.getString("Alpha0"));
	}
     ...
     */
    public void resume() {
	resume(Ding3dClock.currentTimeMillis());
    }
     ...
     */
    public float value() {
	long currentTime = paused ? pauseTime : Ding3dClock.currentTimeMillis();

...
public class Switch extends Group {
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Switch0"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Switch1"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_SWITCH_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Switch2"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_SWITCH_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Switch3"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Switch4"));

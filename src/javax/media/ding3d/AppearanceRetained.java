...
class AppearanceRetained extends NodeComponentRetained {
  ...
  synchronized void removeAMirrorUser(Shape3DRetained shape) {
	...
	createMessage.type = Ding3dMessage.APPEARANCE_CHANGED;
	...
	for(int i=0; i<univList.size(); i++) {
	    Ding3dMessage createMessage = new Ding3dMessage();
	    createMessage.threads = Ding3dThread.UPDATE_GEOMETRY;
	    createMessage.type = Ding3dMessage.RENDERINGATTRIBUTES_CHANGED;

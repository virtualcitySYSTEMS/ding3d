...
public class TransparencyAttributes extends NodeComponent {
   ...
   // Array for setting default read capabilities
	...
	if ((tMode < FASTEST) ||(tMode > NONE)) {
	    throw new IllegalArgumentException(Ding3dI18N.getString("TransparencyAttributes6"));
	}
        ...
        case BLEND_ONE_MINUS_DST_COLOR:
            break;
            default:
            throw new IllegalArgumentException(Ding3dI18N.getString("TransparencyAttributes7"));
        }
        ...
        case BLEND_ONE_MINUS_SRC_COLOR:
            break;
            default:
            throw new IllegalArgumentException(Ding3dI18N.getString("TransparencyAttributes8"));
        }
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_MODE_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("TransparencyAttributes0"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_MODE_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("TransparencyAttributes1"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_VALUE_WRITE))
	    throw new CapabilityNotSetException(Ding3dI18N.getString("TransparencyAttributes2"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_VALUE_READ))
	    throw new CapabilityNotSetException(Ding3dI18N.getString("TransparencyAttributes3"));
	...
	if (isLiveOrCompiled())
		...
		throw new
		    CapabilityNotSetException(Ding3dI18N.getString("TransparencyAttributes4"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("TransparencyAttributes5"));
	...
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_BLEND_FUNCTION_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("TransparencyAttributes4"));

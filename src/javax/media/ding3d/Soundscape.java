...
public class Soundscape extends Leaf {
   ...
   // Array for setting default read capabilities
    ...
    public void setApplicationBounds(Bounds region) {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Soundscape0"));
    ...
    public Bounds getApplicationBounds() {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("Soundscape1"));
    ...
    public void setAuralAttributes(AuralAttributes attributes) {
      if (isLiveOrCompiled())
       if(!this.getCapability(ALLOW_ATTRIBUTES_WRITE))
         throw new CapabilityNotSetException(Ding3dI18N.getString("Soundscape4"));
    ...
    public AuralAttributes getAuralAttributes() {
      if (isLiveOrCompiled())
       if(!this.getCapability(ALLOW_ATTRIBUTES_READ))
         throw new CapabilityNotSetException(Ding3dI18N.getString("Soundscape5"));

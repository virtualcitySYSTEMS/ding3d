   ...
   // Array for setting default read capabilities
    ...
    public void setAppearance(Appearance appearance) {
	    ...
	    if(!this.getCapability(ALLOW_APPEARANCE_WRITE))
	    	throw new CapabilityNotSetException(Ding3dI18N.getString("AlternateAppearance0"));
    ...
    public Appearance getAppearance() {
	    ...
	    if(!this.getCapability(ALLOW_APPEARANCE_READ))
	    	throw new CapabilityNotSetException(Ding3dI18N.getString("AlternateAppearance2"));
    ...
    public void setInfluencingBounds(Bounds region) {
	    ...
	    if(!this.getCapability(ALLOW_INFLUENCING_BOUNDS_WRITE))
	    	throw new CapabilityNotSetException(Ding3dI18N.getString("AlternateAppearance3"));
    ...
    public Bounds getInfluencingBounds() {
	    ...
	    if(!this.getCapability(ALLOW_INFLUENCING_BOUNDS_READ))
	    	throw new CapabilityNotSetException(Ding3dI18N.getString("AlternateAppearance4"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("AlternateAppearance7"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("AlternateAppearance8"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_SCOPE_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("AlternateAppearance9"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_SCOPE_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("AlternateAppearance10"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_SCOPE_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("AlternateAppearance11"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_SCOPE_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("AlternateAppearance12"));

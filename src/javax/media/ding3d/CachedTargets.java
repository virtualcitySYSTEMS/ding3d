...
class CachedTargets {
    // cached targets, used by Ding3d threads
	...
	// GEO
        Ding3dThread.UPDATE_TRANSFORM | Ding3dThread.UPDATE_RENDER |
	Ding3dThread.UPDATE_GEOMETRY,

	// ENV
        Ding3dThread.UPDATE_RENDER | Ding3dThread.UPDATE_RENDERING_ENVIRONMENT,

	// BEH
        Ding3dThread.UPDATE_BEHAVIOR,

	// SND
        Ding3dThread.UPDATE_SOUND | Ding3dThread.SOUND_SCHEDULER,

	// VPF
        Ding3dThread.UPDATE_RENDER | Ding3dThread.UPDATE_BEHAVIOR |
        Ding3dThread.UPDATE_SOUND | Ding3dThread.SOUND_SCHEDULER,

	// BLN
        Ding3dThread.UPDATE_RENDER | Ding3dThread.UPDATE_RENDERING_ENVIRONMENT |
        Ding3dThread.UPDATE_BEHAVIOR | Ding3dThread.UPDATE_SOUND,

	// GRP
        Ding3dThread.UPDATE_TRANSFORM | Ding3dThread.UPDATE_GEOMETRY
    };

...
class ShaderAttributeBindingRetained extends ShaderAttributeRetained {
    String Ding3dAttrName;

    ShaderAttributeBindingRetained() {
    }

    void initDing3dAttrName(String Ding3dAttrName) {
	this.Ding3dAttrName = Ding3dAttrName;
    }
     ...
     * shader attribute
     */
    String getDing3dAttributeName() {
	return Ding3dAttrName;
    }

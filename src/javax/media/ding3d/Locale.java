...
public class Locale extends Object {
	...
	// added to a locale, throw MultipleParentException
	    ...
	    (branchGroup.isLive())) {
	    throw new MultipleParentException(Ding3dI18N.getString("Locale0"));
        }
	...
	createMessage = new Ding3dMessage();
	createMessage.threads = Ding3dThread.UPDATE_RENDER| Ding3dThread.UPDATE_RENDERING_ENVIRONMENT;
    ...
    void doRemoveBranchGraph(BranchGroup branchGroup,
                                Ding3dMessage messages[], int startIndex) {
	...
	if (messages == null) {
	    destroyMessage = new Ding3dMessage();
	} else {
	    destroyMessage = messages[startIndex++];
	}
	destroyMessage.threads = Ding3dThread.UPDATE_RENDER| Ding3dThread.UPDATE_RENDERING_ENVIRONMENT;
	...
	if (! oldGroup.getCapability(BranchGroup.ALLOW_DETACH)) {
	    ...
	    throw new MultipleParentException(Ding3dI18N.getString("Locale3"));
        }
	universe.resetWaitMCFlag();
    ...
    void validateModeFlagAndPickShape(int mode, int flags, PickShape pickShape) {
        ...
        if((mode != PickInfo.PICK_BOUNDS) && (mode != PickInfo.PICK_GEOMETRY)) {
          ...
          throw new IllegalArgumentException(Ding3dI18N.getString("Locale5"));
        }

        if((pickShape instanceof PickPoint) && (mode == PickInfo.PICK_GEOMETRY)) {
          throw new IllegalArgumentException(Ding3dI18N.getString("Locale6"));
        }

        if(((flags & PickInfo.CLOSEST_GEOM_INFO) != 0) &&
                ((flags & PickInfo.ALL_GEOM_INFO) != 0)) {
            throw new IllegalArgumentException(Ding3dI18N.getString("Locale7"));
        }
        ...
        if((mode == PickInfo.PICK_BOUNDS) &&
          ...
          throw new IllegalArgumentException(Ding3dI18N.getString("Locale8"));
        }
        ...
        if((pickShape instanceof PickBounds) &&
          ...
          throw new IllegalArgumentException(Ding3dI18N.getString("Locale9"));
        }
    }
     ...
     * </ul>
     *
     * @see BranchGroup#pickAll(int,int,javax.media.ding3d.PickShape)
     * @see PickInfo
     *
     * @since Java 3D 1.4
     *
     ...
     * </ul>
     *
     * @see BranchGroup#pickAllSorted(int,int,javax.media.ding3d.PickShape)
     * @see PickInfo
     *
     * @since Java 3D 1.4
     *
     ...
     * </ul>
     *
     * @see BranchGroup#pickClosest(int,int,javax.media.ding3d.PickShape)
     * @see PickInfo
     *
     * @since Java 3D 1.4
     *
     ...
     * </ul>
     *
     * @see BranchGroup#pickAny(int,int,javax.media.ding3d.PickShape)
     * @see PickInfo
     *
     * @since Java 3D 1.4
     *

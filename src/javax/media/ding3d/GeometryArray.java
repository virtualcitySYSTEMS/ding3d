...
public abstract class GeometryArray extends Geometry {
  ...
  private static final int Ding3d_1_2_ALLOW_REF_DATA_READ =
    CapabilityBits.Ding3d_1_2_GEOMETRY_ARRAY_ALLOW_REF_DATA_READ;
  ...
  static final int TEXTURE_COORDINATE = TEXTURE_COORDINATE_2 |
     ...
     * accessed via Ding3dBuffer objects that wrap NIO Buffer objects,
     * rather than float, double, byte, or TupleXX arrays.  This flag
     * is only valid in conjunction with the <code>BY_REFERENCE</code>
     * flag.
     *
     * @see Ding3dBuffer
     * @see #setCoordRefBuffer(Ding3dBuffer)
     * @see #setColorRefBuffer(Ding3dBuffer)
     * @see #setNormalRefBuffer(Ding3dBuffer)
     * @see #setTexCoordRefBuffer(int,Ding3dBuffer)
     * @see #setVertexAttrRefBuffer(int,Ding3dBuffer)
     * @see #setInterleavedVertexBuffer(Ding3dBuffer)
     *
     * @since Java 3D 1.3
     */
   ...
   // Array for setting default read capabilities
     ...
     * is accessed via a Ding3dBuffer object that wraps an NIO buffer;
    ...
    public GeometryArray(int vertexCount,
        ...
        if (vertexCount < 0)
            throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray96"));

        if (texCoordSetCount < 0)
            throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray124"));

        if (vertexAttrCount < 0)
            throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray125"));

        if ((vertexFormat & COORDINATES) == 0)
          throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray0"));

        if ((vertexFormat & INTERLEAVED) != 0 &&
            (vertexFormat & BY_REFERENCE) == 0)
            throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray80"));

        if ((vertexFormat & INTERLEAVED) != 0 &&
                (vertexFormat & VERTEX_ATTRIBUTES) != 0) {
            throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray128"));
        }

        if ((vertexFormat & USE_COORD_INDEX_ONLY) != 0 &&
                !(this instanceof IndexedGeometryArray)) {
            throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray135"));
        }

        //NVaidya
        if ((vertexFormat & BY_REFERENCE_INDICES) != 0) {
            if (!(this instanceof IndexedGeometryArray))
                throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray136"));
            if ((vertexFormat & BY_REFERENCE) == 0)
                throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray137"));
            if ((vertexFormat & USE_COORD_INDEX_ONLY) == 0)
                throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray138"));
        }

        if ((vertexFormat & USE_NIO_BUFFER) != 0 &&
            (vertexFormat & BY_REFERENCE) == 0)
	    throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray117"));

	if ((vertexFormat & TEXTURE_COORDINATE) != 0) {
	    if (texCoordSetMap == null)
                throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray106"));

	    if (texCoordSetCount == 0)
                throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray107"));

	    for (int i = 0; i < texCoordSetMap.length; i++) {
	         if (texCoordSetMap[i] >= texCoordSetCount)
                     throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray108"));
	    }
        ...
        if ((vertexFormat & VERTEX_ATTRIBUTES) != 0) {
            if (vertexAttrCount > 0) {
                if (vertexAttrCount != vertexAttrSizes.length) {
                    throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray132"));
                }

                for (int i = 0; i < vertexAttrSizes.length; i++) {
                    if (vertexAttrSizes[i] < 1 || vertexAttrSizes[i] > 4) {
                        throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray133"));
                    }
                }
            } else {
            ...
            if (vertexAttrCount > 0) {
                throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray131"));
            }
        }
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray1"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray2"));
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray88"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_COUNT_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray89"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_COUNT_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray90"));

        if (initialVertexIndex < 0)
	    throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray97"));
	int format = ((GeometryArrayRetained)this.retained).vertexFormat;
	if ((format & BY_REFERENCE) != 0 && (format & INTERLEAVED) == 0)
	    throw new IllegalStateException(Ding3dI18N.getString("GeometryArray105"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_COUNT_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray91"));
  ...
  public void setCoordinate(int index, float coordinate[]) {
    ...
    if(!this.getCapability(ALLOW_COORDINATE_WRITE))
      throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray3"));

    int format = ((GeometryArrayRetained)this.retained).vertexFormat;
    if ((format & BY_REFERENCE) != 0)
      throw new IllegalStateException(Ding3dI18N.getString("GeometryArray82"));
  ...
  public void setCoordinates(int index, float coordinates[]) {
    if (isLiveOrCompiled())
    if(!this.getCapability(ALLOW_COORDINATE_WRITE))
      throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray7"));
  ...
  public void setColor(int index, float color[]) {
    ...
    if(!this.getCapability(ALLOW_COLOR_WRITE))
      throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray15"));
    ...
    if ((format & COLOR) == 0)
      throw new ArrayIndexOutOfBoundsException(Ding3dI18N.getString("GeometryArray76"));
  ...
  public void setColor(int index, Color3f color) {
    ...
    if ((format & WITH_ALPHA) != 0)
      throw new IllegalStateException(Ding3dI18N.getString("GeometryArray92"));
  ...
  public void setColor(int index, Color4f color) {
    ...
    if ((format & WITH_ALPHA) == 0)
      throw new IllegalStateException(Ding3dI18N.getString("GeometryArray93"));
  ...
  public void setColors(int index, float colors[]) {
    if (isLiveOrCompiled())
    if(!this.getCapability(ALLOW_COLOR_WRITE))
      throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray21"));
  ...
  public void setNormal(int index, float normal[]) {
    ...
    if(!this.getCapability(ALLOW_NORMAL_WRITE))
      throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray33"));
    ...
    if ((format & NORMALS ) == 0)
      throw new ArrayIndexOutOfBoundsException(Ding3dI18N.getString("GeometryArray77"));
  ...
  public void setNormals(int index, float normals[]) {
    if (isLiveOrCompiled())
    if(!this.getCapability(ALLOW_NORMAL_WRITE))
      throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray35"));
  ...
  public void setNormals(int index, Vector3f normals[],
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray39"));
	...
	if (((((GeometryArrayRetained)this.retained).vertexFormat) &
	    ...
	    throw new IllegalStateException(Ding3dI18N.getString("GeometryArray94"));
	...
	if (((((GeometryArrayRetained)this.retained).vertexFormat) &
	    ...
	    throw new IllegalStateException(Ding3dI18N.getString("GeometryArray95"));
	...
	if (((((GeometryArrayRetained)this.retained).vertexFormat) &
	    ...
	    throw new IllegalStateException(Ding3dI18N.getString("GeometryArray109"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_TEXCOORD_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray42"));
	...
	if (isLiveOrCompiled()) {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray126"));
	    }
	}
	...
	if (size != 2) {
	    throw new IllegalStateException(Ding3dI18N.getString("GeometryArray134"));
	}
  ...
  public void getCoordinate(int index, float coordinate[]) {
    ...
    if(!this.getCapability(ALLOW_COORDINATE_READ))
      throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray48"));
  ...
  public void getCoordinates(int index, float coordinates[]) {
    if (isLiveOrCompiled())
    if(!this.getCapability(ALLOW_COORDINATE_READ))
      throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray52"));
  ...
  public void getColor(int index, float color[]) {
    ...
    if(!this.getCapability(ALLOW_COLOR_READ))
      throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray56"));
  ...
  public void getColors(int index, float colors[]) {
    if (isLiveOrCompiled())
    if(!this.getCapability(ALLOW_COLOR_READ))
      throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray62"));
  ...
  public void getNormal(int index, float normal[]) {
    ...
    if(!this.getCapability(ALLOW_NORMAL_READ))
      throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray68"));
  ...
  public void getNormals(int index, float normals[]) {
    if (isLiveOrCompiled())
    if(!this.getCapability(ALLOW_NORMAL_READ))
      throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray70"));
  ...
  public void getNormals(int index, Vector3f normals[]) {
	...
	if (isLiveOrCompiled())
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray72"));
	...
	if ((format & TEXTURE_COORDINATE ) == 0)
	    throw new ArrayIndexOutOfBoundsException(Ding3dI18N.getString("GeometryArray79"));
	...
	if (isLiveOrCompiled())
	    if(!this.getCapability(ALLOW_TEXCOORD_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray75"));
	...
	if (isLiveOrCompiled()) {
		...
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray127"));
	    }
	}
	...
	int format = ((GeometryArrayRetained)this.retained).vertexFormat;
	    ...
	    throw new IllegalArgumentException(Ding3dI18N.getString("GeometryArray97"));
	if ((format & BY_REFERENCE) == 0)
	    throw new IllegalStateException(Ding3dI18N.getString("GeometryArray83"));

	if ((format & INTERLEAVED) != 0)
	    throw new IllegalStateException(Ding3dI18N.getString("GeometryArray84"));
     ...
     *
     * @param coords a Ding3dBuffer object to which a reference will be set.
     ...
     * contained in the specified Ding3dBuffer is not a
     ...
     * @since Java 3D 1.3
     */
    public void setCoordRefBuffer(Ding3dBuffer coords) {
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_REF_DATA_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray86"));

	int format = ((GeometryArrayRetained)this.retained).vertexFormat;

	if ((format & USE_NIO_BUFFER) == 0)
	    throw new IllegalStateException(Ding3dI18N.getString("GeometryArray118"));
     ...
     * @since Java 3D 1.3
     */
    public Ding3dBuffer getCoordRefBuffer() {
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_REF_DATA_READ) &&
		   !this.getCapability(Ding3d_1_2_ALLOW_REF_DATA_READ)) {
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray87"));
	    }
	...
	if ((format & USE_NIO_BUFFER) != 0)
	    throw new IllegalStateException(Ding3dI18N.getString("GeometryArray119"));
     ...
     * this geometry array will not be drawn.
     *
     * @param colors a Ding3dBuffer object to which a reference will be set.
     ...
     * @since Java 3D 1.3
     */
    public void setColorRefBuffer(Ding3dBuffer colors) {
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_REF_DATA_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray86"));
     ...
     * @since Java 3D 1.3
     */
    public Ding3dBuffer getColorRefBuffer() {
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_REF_DATA_READ) &&
		   !this.getCapability(Ding3d_1_2_ALLOW_REF_DATA_READ)) {
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray87"));
     ...
     * drawn.
     *
     * @param normals a Ding3dBuffer object to which a reference will be set.
     ...
     * @since Java 3D 1.3
     */
    public void setNormalRefBuffer(Ding3dBuffer normals) {
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_REF_DATA_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray86"));
     ...
     * @since Java 3D 1.3
     */
    public Ding3dBuffer getNormalRefBuffer() {
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_REF_DATA_READ) &&
		   !this.getCapability(Ding3d_1_2_ALLOW_REF_DATA_READ)) {
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray87"));
     ...
     *
     * @param texCoordSet texture coordinate set in this geometry array
     * @param texCoords a Ding3dBuffer object to which a reference will be set.
     ...
     * @since Java 3D 1.3
     */
    public void setTexCoordRefBuffer(int texCoordSet, Ding3dBuffer texCoords) {
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_REF_DATA_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray86"));
     ...
     * @since Java 3D 1.3
     */
    public Ding3dBuffer getTexCoordRefBuffer(int texCoordSet) {
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_REF_DATA_READ) &&
		   !this.getCapability(Ding3d_1_2_ALLOW_REF_DATA_READ)) {
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray87"));
     ...
     * @param vertexAttrNum vertex attribute number in this geometry array
     *
     * @param vertexAttrs a Ding3dBuffer object to which a reference will
     ...
     * @since Java 3D 1.4
     */
    public void setVertexAttrRefBuffer(int vertexAttrNum, Ding3dBuffer vertexAttrs) {
	if (isLiveOrCompiled()) {
	    if (!this.getCapability(ALLOW_REF_DATA_WRITE)) {
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray86"));
	    }
     ...
     * @since Java 3D 1.4
     */
    public Ding3dBuffer getVertexAttrRefBuffer(int vertexAttrNum) {
	if (isLiveOrCompiled()) {
	    if (!this.getCapability(ALLOW_REF_DATA_READ) &&
		!this.getCapability(Ding3d_1_2_ALLOW_REF_DATA_READ)) {
	...
	int format = ((GeometryArrayRetained)this.retained).vertexFormat;
	if ((format & INTERLEAVED) == 0)
	    throw new IllegalStateException(Ding3dI18N.getString("GeometryArray85"));
     ...
     * <i>words_per_vertex</i>*<i>n</i>.
     *
     * @param vertexData a Ding3dBuffer object to which a reference will be set.
     ...
     * @since Java 3D 1.3
     */
    public void setInterleavedVertexBuffer(Ding3dBuffer vertexData) {
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_REF_DATA_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray86"));
     ...
     * @since Java 3D 1.3
     */
    public Ding3dBuffer getInterleavedVertexBuffer() {
	if (isLiveOrCompiled())
	    if (!this.getCapability(ALLOW_REF_DATA_READ) &&
		   !this.getCapability(Ding3d_1_2_ALLOW_REF_DATA_READ)) {
		throw new CapabilityNotSetException(Ding3dI18N.getString("GeometryArray87"));

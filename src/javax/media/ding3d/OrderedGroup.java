...
public class OrderedGroup extends Group {
	...
	if (isLiveOrCompiled())
		...
		throw new
		    CapabilityNotSetException(Ding3dI18N.getString("OrderedGroup5"));
	...
	if (((OrderedGroupRetained)retained).userChildIndexOrder != null) {
	    throw new IllegalStateException(Ding3dI18N.getString("OrderedGroup6"));
	}
	...
	if (isLiveOrCompiled()) {
		...
		throw new
		    CapabilityNotSetException(Ding3dI18N.getString("OrderedGroup4"));
	}
	...
	if(cIOArr != null) {
		...
		throw new
		    IllegalArgumentException(Ding3dI18N.getString("OrderedGroup0"));
	    }
		...
		if(cIOArr[i] < 0) {
		    throw new
			IllegalArgumentException(Ding3dI18N.getString("OrderedGroup1"));
		}
		else if(cIOArr[i] >= cIOArr.length) {
		    throw new
			IllegalArgumentException(Ding3dI18N.getString("OrderedGroup2"));
		}
		else if(checkArr[cIOArr[i]]) {
		    throw new
			IllegalArgumentException(Ding3dI18N.getString("OrderedGroup3"));
		}
		else {

...
public class SensorRead {
	...
	// Do this last
	this.time = Ding3dClock.currentTimeMillis();
    }
    ...
    */
    public void setButtons(int[] values) {
          if(numButtons == 0)
              ...
              throw new ArrayIndexOutOfBoundsException(Ding3dI18N.getString("SensorRead1"));

          else if(values.length < numButtons)

              throw new ArrayIndexOutOfBoundsException(Ding3dI18N.getString("SensorRead0"));

   ...
   // Array for setting default read capabilities
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_COMPONENT_WRITE))
	    throw new CapabilityNotSetException(Ding3dI18N.getString("Material0"));
	if (isLive()) {
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_COMPONENT_READ))
	    throw new CapabilityNotSetException(Ding3dI18N.getString("Material2"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_COMPONENT_WRITE))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Material15"));
	if (isLive())
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_COMPONENT_READ))
		throw new CapabilityNotSetException(Ding3dI18N.getString("Material16"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_COMPONENT_WRITE))
	    throw new CapabilityNotSetException(Ding3dI18N.getString("Material3"));
	...
	if (isLiveOrCompiled())
	  if (!this.getCapability(ALLOW_COMPONENT_READ))
	    throw new CapabilityNotSetException(Ding3dI18N.getString("Material4"));
	...
	public String toString() {
		...
		str.append("javax.media.ding3d.Material: ");
